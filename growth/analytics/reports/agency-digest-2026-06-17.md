# Suite → Agency — Weekly Digest (auto), 2026-06-17

*Auto-assembled by `weekly-digest-runner.mjs` · window 2026-06-10→2026-06-17 · Plausible + Supabase (live). No fabricated data; `n/a` = source unavailable. North star = `assessment_request` where `source=suite`.*
...
## Funnel (Plausible, 2026-06-10→2026-06-17)
| Stage | Event | Count |
|-------|-------|------:|
| Agency visits | tsukumo_visit | 29 |
| Suite→agency clicks | suite_to_agency_click | 0 |
| Intent | intent_page_view | 23 |
| CTA / contact | cta_clicked + contact_clicked | 6 + 0 |
