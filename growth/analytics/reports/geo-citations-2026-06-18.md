# GEO Citation-Share — 2026-06-18 (openai-web-search)
...
**Suite citation share: 0/10 queries (0%)** — i.e. of the ICP questions probed, the share where trovex/tsukumo/wrai.th/yoru.sh was cited.

| Query | Kind | We cited? | Our URL(s) | Competitors cited | Total citations |
|-------|------|:---------:|-----------|-------------------|----------------:|
| context-fewer-tokens | category | — | — | — | 10 |
| stop-rereading-repo | category | — | — | — | 10 |
| ssot-multiple-agents | category | — | — | — | 0 |
| reduce-agent-token-cost | category | — | — | cursor | 9 |
| claude-md-alternative | comparison | — | — | — | 1 |
| repomix-alternative | comparison | — | — | repomix | 7 |
| mcp-context-server | category | — | — | cursor | 5 |
| brand-trovex | branded | — | — | — | 3 |
| consulting-agents-prod | consulting | — | — | — | 8 |
| agentic-operators-studio | consulting | — | — | — | 9 |
