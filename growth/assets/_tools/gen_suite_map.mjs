...
// real numbers only. dokan is 4th-pillar PREP -> carries an "beta" tag (never
...
const PILLARS = [
  ...
  { word: [["dokan", 1]], accent: "#22d3ee", role: "the script runtime", sub: "deterministic automation, zero LLM inside", tag: "beta" },
];
