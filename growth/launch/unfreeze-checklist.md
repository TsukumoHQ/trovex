# trovex — public-launch un-freeze checklist (DRAFT)

**Status:** DRAFT / runbook. Do NOT start until cmo lifts the public hold (gtm-model). Today: private beta.
**Owner:** launch-lead · **Reviewed against:** gtm-model, public-launch-blockers, mcp-registries.md, voice, no-synergix-mention
**Use:** the ordered steps to flip from private beta → public OSS launch. Each `[ ]` has an owner. Don't skip the gate.

---

## 0. Go-decision gate (cmo) — don't start until all true
...
- [ ] cmo explicitly lifts the public hold. Until then everything below stays frozen.
