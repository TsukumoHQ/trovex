...
# Default rerank model. Override globally with CTX_RERANK_MODEL, or per-request
# with the X-CTX-Rerank-Model header (allow-list: gpt-5.* family).
DEFAULT_MODEL = os.environ.get("CTX_RERANK_MODEL", "gpt-5.4-mini")
